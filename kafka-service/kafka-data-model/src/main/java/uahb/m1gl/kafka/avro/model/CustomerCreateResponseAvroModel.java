...
public class CustomerCreateResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2716655182603888716L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CustomerCreateResponseAvroModel\",\"namespace\":\"uahb.m1gl.kafka.avro.model\",\"fields\":[{\"name\":\"clientId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"message\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"customerStatut\",\"type\":{\"type\":\"enum\",\"name\":\"CustomerStatut\",\"symbols\":[\"CREATED\",\"EXIST\"]}}]}");
  ...
  private uahb.m1gl.kafka.avro.model.CustomerStatut customerStatut;
   ...
   */
  public CustomerCreateResponseAvroModel(java.lang.String clientId, java.lang.String message, uahb.m1gl.kafka.avro.model.CustomerStatut customerStatut) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: customerStatut = (uahb.m1gl.kafka.avro.model.CustomerStatut)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public uahb.m1gl.kafka.avro.model.CustomerStatut getCustomerStatut() {
   ...
   * @param value the value to set.
   */
  public void setCustomerStatut(uahb.m1gl.kafka.avro.model.CustomerStatut value) {
   ...
   */
  public static uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder newBuilder() {
    return new uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder();
  }
   ...
   * @return A new CustomerCreateResponseAvroModel RecordBuilder
   */
  public static uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder newBuilder(uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder other) {
    if (other == null) {
      return new uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder();
    } else {
      return new uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new CustomerCreateResponseAvroModel RecordBuilder
   */
  public static uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder newBuilder(uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel other) {
    if (other == null) {
      return new uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder();
    } else {
      return new uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerCreateResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.clientId)) {
        this.clientId = data().deepCopy(fields()[0].schema(), other.clientId);
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder setClientId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder clearClientId() {
      clientId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder setMessage(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder clearMessage() {
      message = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder setCustomerStatut(uahb.m1gl.kafka.avro.model.CustomerStatut value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public uahb.m1gl.kafka.avro.model.CustomerCreateResponseAvroModel.Builder clearCustomerStatut() {
      customerStatut = null;
    ...
    public CustomerCreateResponseAvroModel build() {
      try {
        ...
        record.customerStatut = fieldSetFlags()[2] ? this.customerStatut : (uahb.m1gl.kafka.avro.model.CustomerStatut) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.customerStatut = uahb.m1gl.kafka.avro.model.CustomerStatut.values()[in.readEnum()];
